# CodeIgnitor 3.2 Sales Funnel Application

CodeIgnitor 3.2 based Sales Funnel Application, used to role based User Login, Registration, Dashboard and CRUD for Manage Customers, Manage Vehicles. Advanced Bootstrap 4.0 based UI for Admin Dashboard (AdminLTE). <br>
